    ...
    <>
      <PageMeta
        ...
        jsonLd={{
          ...
          "@type": "Report",
          name: "The Future Skills Report 2026: What Kenyan Kids Need",
          description: "Research-backed analysis of skills Kenyan children need in the AI era.",
      ...
      <div className="relative min-h-[50vh] flex flex-col justify-end overflow-hidden bg-gradient-to-br from-[#0D0C18] via-[#0B4D5F] to-[#7F5AF0]/30">
        <div className="relative z-10 px-6 md:px-14 pb-16 pt-32 max-w-4xl">
          ...
          <p className="text-lg text-white/70 max-w-2xl leading-relaxed mb-6">
            What Kenyan kids actually need before 2030, backed by parent research, not hype.
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          <Reveal>
            ...
            <p className="text-base text-[#4A4860] leading-relaxed max-w-3xl">
              This report maps proven parent concerns to six skills that remain valuable when AI automates everything else, and what Kenyan families can do about it today.
            </p>
          </Reveal>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          <Reveal>
            <h2 className="font-serif text-3xl font-bold text-[#0D0C18] mb-10">
              The six skills Kenyan kids need before 2030
            </h2>
          </Reveal>
          ...
          <Reveal delay={80}>
            <div className="bg-[#0B4D5F] rounded-2xl p-8 text-white">
              ...
              <p className="text-sm text-white/70 leading-relaxed mb-6">
                Four programme stages (ages 8–17) built around one cycle: Think First, Write Creatively, Use AI, Present. Not a coding camp. Cognitive resilience training for the AI era.
              </p>
              <Link
                href="/programme"
